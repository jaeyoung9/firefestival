 ...
 * 
 * @Override public void insertgoodsimg(Map<String, Object> map,
 * HttpServletRequest request) throws Exception { List<Map<String, Object>> list
 * = fileUtils.noticeUpload(map, request); for (int i = 0; i < list.size(); i++)
 * { Map<String, Object> vo = list.get(i); fileDao.insertgoodsimg(vo); }
 * 
 * // test MultipartHttpServletRequest multipartHttpServletRequest =
 ...
 * }
 * 
 * @Override public void insertgoodsthumb(Map<String, Object> map,
 * HttpServletRequest request) throws Exception { List<Map<String, Object>> list
 * = fileUtils.parseInsertFileInfo2(map, request); for (int i = 0; i <
 * list.size(); i++) { Map<String, Object> vo = list.get(i);
 ...
 * }
 * 
 * @Override public void insertnotice(Map<String, Object> map,
 * HttpServletRequest request) throws Exception { List<Map<String, Object>> list
 * = fileUtils.parseInsertFileInfo3(map, request); for (int i = 0; i <
 * list.size(); i++) { Map<String, Object> vo = list.get(i);
