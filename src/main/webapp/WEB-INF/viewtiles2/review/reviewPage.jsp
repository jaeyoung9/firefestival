...
<colgroup>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			fn_reviewPage(1); //최초에 화면이 호출되면 1페이지의 내용을 조회하는 것을 의미.
		...
		function fn_reviewPage(pageNo) { //파라미터로 pageNo를 받는다. (pageNo는 호출하고자 하는 페이지 번호를 의미)
			var comAjax = new ComAjax(); //coomon.js파일에 ComAjax를 사용.
			comAjax.setUrl("<c:url value='/reviewPage/page'/>");
